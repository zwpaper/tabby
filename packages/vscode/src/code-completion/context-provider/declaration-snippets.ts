// Modified from: https://github.com/TabbyML/tabby/blob/493cef3b3229548175de430dbc7f7e4a092ca507/clients/tabby-agent/src/contextProviders/declarationSnippets.ts
...
const logger = getLogger("CodeCompletion.DeclarationSnippetsProvider");
