...
![User button overview](/images/api-overview.png)

2. Create a new API key with a descriptive name
3. Copy the generated key (it's only shown once)

![API page interface](/images/api-page-interface.png)
...
![Comment example](/images/github-comment.png)
...
![Progress example](/images/github-progress.png)

![Actions run example](/images/github-action-run.png)
