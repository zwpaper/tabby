...
## Groups
Tabby enforces [Code Browser](../code-browser) access permissions through user groups. Administrators can granularly control which teams can access designated resources.
